...
*Web Developer* - *Freelance*
 - Development of a fast and modern Gatsby (React) website using WordPress as a backend.
 - Production of several custom WordPress plugins to foster custom data types
 - Optimisation of SEO using metrics such as Lighthouse and GTMetrix

**Iceline Hosting** `Aug 2020 - Dec 2020`

*Systems Administrator* - *Part Time*
 - Systems administrator and junior developer.

**Harler** `Mar 2020 - July 2020`

*WordPress Developer* - *Freelance*
 - Production of a bespoke WordPress theme with a focus on dynamic data and SEO.
 - Production of several custom WordPress plugins to allow for custom data types and interactive content.

## Education

**University of Southampton** `2020 - 2024`

*MEng Computer Science* - *2:1 (Expected)*
 - Secretary and Tech Officer for Southampton University Rifle Club (2021-22)
 - Indoor Individual Sports Representative for the Athletic Union (2021-22)
 - Involved in Southampton University Trampoline Club

**Billericay Sixth Form** `2018 - 2020`

*A-Levels in Mathematics (A), Further Mathematics (A), Computer Science (A)*
